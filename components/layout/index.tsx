...
export default function Layout({
  ...
  return (
    <>
      ...
      <div className="h-full w-full bg-hero-pattern bg-center antialiased">
        <header className="w-full">
          <div className="mx-5 flex h-16 max-w-screen-xl items-center justify-between xl:mx-auto">
            ...
            >
              <p className="monoSpace font-sans font-bold text-white">
                CodingBuddy
              </p>
            </Link>
      ...
      <footer className="mx-auto w-full max-w-screen-xl py-10 text-gray">
        <div className="flex flex-col items-center text-sm md:flex-row md:justify-between">
          <p className="monoSpace order-2 mt-3 space-y-4 text-sm md:order-1 md:mt-0">
